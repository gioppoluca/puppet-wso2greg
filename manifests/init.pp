...
/*    require   => [
#      File["/opt/wso2greg-$version/repository/conf/user-mgt.xml"],
#      File["/opt/wso2greg-$version/repository/conf/registry.xml"],
      File["/opt/wso2greg-$version/bin/wso2server.sh"],
#      File["/opt/wso2greg-$version/repository/conf/datasources/master-datasources.xml"]],
 */  
